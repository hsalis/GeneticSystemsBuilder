...
def main():
    print('Testing Sequence Constraint Validation Checkers ... ', end=' ')
    ...
    print('Testing Sequence Constraint Sufficiency Checkers ... ', end=' ')
    ...
    print('Testing Struture Constraint Validation Checkers ...', end=' ')
    struct = '....(((.xx.)))...()...(())...'
    ...
    print('Testing Struture Constraint Homology Conflict Checkers ...', end=' ')
    struct = '(((((((((((......)))))))))))...(((((((((((......)))))))))))'
    homology = 10
