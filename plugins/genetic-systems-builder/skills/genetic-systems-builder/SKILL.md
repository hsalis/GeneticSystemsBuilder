---
name: genetic-systems-builder
description: Use when working with Genetic Systems Builder (GSB), including preparing CSV, Excel, FASTA, GenBank, or JSON sequence inputs; running the `gsb` CLI or `GeneticSystemsCalculator_Build.py`; designing Golden Gate oligo pools and primer plates; handling combinatorial assemblies; interpreting exported workbooks; and troubleshooting dependency, input, enzyme, or assembly failures.
---
